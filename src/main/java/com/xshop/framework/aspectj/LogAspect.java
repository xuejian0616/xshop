package com.xshop.framework.aspectj;
...
import com.xshop.project.monitor.operlog.service.IOperLogService;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.xshop.framework.aspectj.lang.annotation.Log)")
    ...
    private void handleLog(final JoinPoint joinPoint, final Exception e)
    {
        try
        {
            ...
            if (currentUser != null)
            {
                ...
                operLog.setRoleName(currentUser.getRoles());
            }
