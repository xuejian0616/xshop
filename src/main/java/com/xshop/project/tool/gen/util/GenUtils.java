package com.xshop.project.tool.gen.util;

import java.util.ArrayList;
import java.util.List;
import org.apache.velocity.VelocityContext;
import com.xshop.common.constant.CommonConstant;
import com.xshop.common.constant.CommonMap;
import com.xshop.common.utils.DateUtils;
import com.xshop.common.utils.StringUtils;
import com.xshop.framework.config.GenConfig;
import com.xshop.project.tool.gen.domain.ColumnInfo;
import com.xshop.project.tool.gen.domain.TableInfo;
...
{
    /** 项目空间路径 */
    private static final String projectPath = "main/java/com/xshop/project";
    ...
    /** js空间路径 */
    private static final String javascriptPath = "main/resources/static/xshop/";
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("com.xshop.project.system"));
    }
}
