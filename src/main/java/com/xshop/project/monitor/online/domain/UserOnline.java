package com.xshop.project.monitor.online.domain;

import com.xshop.framework.web.domain.BaseEntity;
import com.xshop.project.monitor.online.domain.OnlineSession.OnlineStatus;
...
public class UserOnline extends BaseEntity
{
    ...
    {
        return "UserOnline [sessionId=" + sessionId + ", roleName=" + roleName + ", loginName=" + loginName
