...
$(function() {
    ...
    function menuItem() {
        ...
        $('.menuTab').each(function() {
            if ($(this).data('id') == dataUrl) {
                if (!$(this).hasClass('active')) {
                    ...
                    scrollToTab(this);
                    // 显示tab对应的内容区
                    $('.mainContent .xshop_iframe').each(function() {
                        if ($(this).data('id') == dataUrl) {
        ...
        if (flag) {
            ...
            $('.mainContent').find('iframe.xshop_iframe').hide().parents('.mainContent').append(str1);
    ...
    function closeOtherTabs() {
        $('.page-tabs-content').children("[data-id]").not(":first").not(".active").each(function() {
            $('.xshop_iframe[data-id="' + $(this).data('id') + '"]').remove();
            $(this).remove();
        });
    ...
    function refreshTab() {
    	...
    	var target = $('.xshop_iframe[data-id="' + currentId + '"]');
    ...
    $('.tabCloseAll').on('click', function() {
        ...
        $('.page-tabs-content').children("[data-id]:first").each(function() {
            $('.xshop_iframe[data-id="' + $(this).data('id') + '"]').show();
